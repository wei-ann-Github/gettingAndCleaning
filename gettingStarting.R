getwd()
# setwd when working on my lenovo or pavillion mini
setwd("./github/gettingAndCleaning")

# setwd when working off my thumb drive
setwd("E:/gettingAndCleaning")
...
The code should have a file run_analysis.R in the main directory that can be run as long as the Samsung data is in 
your working directory. The output should be the tidy data set you submitted for part 1. 
